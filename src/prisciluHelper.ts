...
export class PrisciluHelper {
    ...
    public addDialogues(baseJson: any, dialogues: any, dbTables: IDatabaseTables): void {
        dbTables.traders[baseJson._id].dialogue = {};
        dbTables.traders[baseJson._id].dialogue.insuranceStart = dialogues.insuranceStart;
        dbTables.traders[baseJson._id].dialogue.insuranceFound = dialogues.insuranceFound;
        dbTables.traders[baseJson._id].dialogue.insuranceFailed = dialogues.insuranceFailed;
        dbTables.traders[baseJson._id].dialogue.insuranceFailedLabs = dialogues.insuranceFailedLabs;
